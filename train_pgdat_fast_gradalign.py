...
from pgd_fast_gradalign import training_loss
...
parser.add_argument('--model-name', default='pgdat_fast_gradalign',
...
elif args.arch == 'presnet64':
    from models.preact_resnet64 import PreActResNet50
    model = PreActResNet50(num_classes=num_classes).to(device)
