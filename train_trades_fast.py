...
from trades_fast import training_loss
...
parser.add_argument('--model-name', default='trades_fast',
...
def train(args, model, device, train_loader, optimizer, epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        loss, loss_init, loss_adv = training_loss(model=model,
                             x_natural=data,
                             y=target,
                             optimizer=optimizer,
        ...
        # init_losses.append(loss_init.item())
        # adv_losses.append(loss_adv.item())

        # with open(os.path.join(out_dir_name, 'init_losses.txt'), 'w') as outfile:
        #     json.dump(init_losses, outfile)
        # with open(os.path.join(out_dir_name, 'adv_losses.txt'), 'w') as outfile:
        #     json.dump(adv_losses, outfile)
